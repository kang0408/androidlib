package com.langk.base.dialog;

import com.langk.base.resoure.ResourceUtil;
import com.langk.base.util.DensityUtil;
...
public class CustomToast {
    ...
    private static CustomToast makeText(Context context, CharSequence text,
        ...
        mLayout.setBackgroundResource(resourceUtil.getDrawableResourceId("shape_item_toast_bg"));
